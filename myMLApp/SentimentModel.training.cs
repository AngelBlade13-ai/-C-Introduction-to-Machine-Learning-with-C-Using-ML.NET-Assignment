...
namespace MyMLApp
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\blade\source\repos\myMLApp\myMLApp\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=6,MinimumExampleCountPerLeaf=16,NumberOfTrees=11,MaximumBinCountPerFeature=219,FeatureFraction=0.9467647529513123,LearningRate=0.18527348110601002,LabelColumnName=@"col1",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"col1"))      
